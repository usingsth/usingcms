      ...
      <div class="content-box-content">
        <div class="tab-content  default-tab" id="tab2">
          <form action="" method="post">
			...
			<p id="cate_p">
              <label>父级id</label>
              <input class="text-input small-input" type="text" name="cate_id" value="1" id="hidden_input"/>
...
$(function(){
	$("#cate_p select").live('change',function(){
		...
		$.ajax({
			type:'get',
			url:'index.php?a=next&c=news&admin=1&pid='+pid,
			dataType:'json',
			success:function(msg){
				...
				l = '';
				l += '<select name="cate_id" class="small-input" id="pid'+next_num+'">';
