      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
          ...
          <div class="notification attention png_bg"> <a href="#" class="close"><img src="resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
            <div><h5>你是 <b><?php echo $_SESSION['level_id'] ?></b> 级 管理员，可以编辑管理你的下级。</h> </div>
          </div>
          <table>
            <thead>
              <tr>
			...
			<?php foreach($res as $k=>$v): ?>
              <tr>
                ...
                <td>
                  <!-- Icons -->
                  <a href="index.php?c=mode&a=update&admin=1&id=<?php echo $v['id'];?>" title="Edit"><img src="resources/images/icons/pencil.png" alt="Edit" /></a> 
				  <a href="index.php?c=mode&a=delete&admin=1&id=<?php echo $v['id'];?>" title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" /></a> </td>
              </tr>
			  <?php endforeach; ?>
            </tbody>
          </table>
